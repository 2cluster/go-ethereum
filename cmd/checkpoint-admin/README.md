...
*For a more detailed introduction to checkpoint, please see the LES [spec](https://github.com/2cluster/devp2p/blob/master/caps/les.md).*
...
```shell
go get github.com/2cluster/go-ethereum/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/2cluster/go-ethereum/blob/master/params/config.go#L251).*
