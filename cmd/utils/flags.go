...
import (
	...
	"github.com/2cluster/go-ethereum/accounts"
	"github.com/2cluster/go-ethereum/accounts/keystore"
	"github.com/2cluster/go-ethereum/common"
	"github.com/2cluster/go-ethereum/common/fdlimit"
	"github.com/2cluster/go-ethereum/consensus"
	"github.com/2cluster/go-ethereum/consensus/clique"
	"github.com/2cluster/go-ethereum/consensus/ethash"
	"github.com/2cluster/go-ethereum/core"
	"github.com/2cluster/go-ethereum/core/rawdb"
	"github.com/2cluster/go-ethereum/core/vm"
	"github.com/2cluster/go-ethereum/crypto"
	"github.com/2cluster/go-ethereum/eth"
	"github.com/2cluster/go-ethereum/eth/downloader"
	"github.com/2cluster/go-ethereum/eth/gasprice"
	"github.com/2cluster/go-ethereum/ethdb"
	"github.com/2cluster/go-ethereum/ethstats"
	"github.com/2cluster/go-ethereum/graphql"
	"github.com/2cluster/go-ethereum/internal/ethapi"
	"github.com/2cluster/go-ethereum/internal/flags"
	"github.com/2cluster/go-ethereum/les"
	"github.com/2cluster/go-ethereum/log"
	"github.com/2cluster/go-ethereum/metrics"
	"github.com/2cluster/go-ethereum/metrics/exp"
	"github.com/2cluster/go-ethereum/metrics/influxdb"
	"github.com/2cluster/go-ethereum/miner"
	"github.com/2cluster/go-ethereum/node"
	"github.com/2cluster/go-ethereum/p2p"
	"github.com/2cluster/go-ethereum/p2p/discv5"
	"github.com/2cluster/go-ethereum/p2p/enode"
	"github.com/2cluster/go-ethereum/p2p/nat"
...
func SetShhConfig(ctx *cli.Context, stack *node.Node) {
	if ctx.GlobalIsSet(WhisperEnabledFlag.Name) ||
		...
		log.Warn("Whisper support has been deprecated and the code has been moved to github.com/2cluster/whisper")
	}
}
